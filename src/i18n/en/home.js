export default {
  ...
  faq: {
    ...
    currentstage: {
      ...
      answer: 'LSPD:MP is still in development. The current phase of development is : Pre-Alpha. If you want to get news about the evolution of the development, refer to the JOIN OUR DISCORD section.'
    },
    join: {
    ...
    free: {
      ...
      answer: 'LSPD:MP is still in an early phase of is development. However, LSPD:MP is targeted to be 100% free. At some points in the life of the server, LSPD:MP could ask for donations, but all the content of the server will always remain free of charge.'
    },
  },
